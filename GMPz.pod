...
=head1 FUNCTIONS
   ...
   $si = Rmpz_cmp_ui($op, $ui);
    ...
    NOTE: Rmpz_cmp_NV also accepts an IV as the 2nd argument,
          which it then casts to an NV. This is probably not
          what you want if IV precision is greater than NV
          precision.
