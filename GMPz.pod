...
=head1 FUNCTIONS
   ...
   $rop = new Math::GMPz($arg);
    ...
    a number (IV, UV or NV) or a string that represents an integer value.
    Strings that are written in scientific notation (eg '1e200' or
    '0x9p+40') are not currently accepted. Such arguments could, eg,
    be made "acceptable" if rewritten as '1'.('0'x200) or,
    respectively, '0b1001'.('0'x40).
