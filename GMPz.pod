...
=head1 FUNCTIONS
   ...
   OPERATOR OVERLOADING
    ...
    Math::BigInt objects, Math::GMPq objects and Math::MPFR
   ...
   'Math::GMPz', 'Math::GMPq', or 'Math::MPFR' will not work.
    ...
    '-', '-=', '*', '*=', '/', '/=, '**' and '**==' operators - in which
    case the operation will return a Math::MPFR object (calculated using
    default Math::MPFR precision and default Math::MPFR rounding mode).
    ...
    Math-GMPq-0.61 or later is installed, with '+', '+=',  '-', '-=',
    '/', '/=', '%', '%=', '*' and '*=' operators (in which case a
    Math::GMPq object is returned).
