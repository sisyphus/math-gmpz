...
=head1 FUNCTIONS
   ...
   Rmpz_import($rop, $len, $order, $size, $endian, $nails, $bstr);
    ...
    NOTE: The actual data contained in $bstr is read in, byte by byte.
          Hence, eg., a string containing any non-ASCII characters will
          therefore assign a different value to $rop if a
          utf8::upgrade($bstr) has been done.
