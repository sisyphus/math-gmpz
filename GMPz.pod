...
=head1 FUNCTIONS
   ...
   $str = Rmpz_export($order, $size, $endian, $nails, $op);
    ...
    This returned $str will be equal to the original string passed to
    Rmpz_import if and only if:
    ...
    suggests that you ought to utf8::upgrade the string returned by
    Rmpz_export.
