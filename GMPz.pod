...
=head1 FUNCTIONS
   ...
   $rop = new Math::GMPz($arg);
    ...
    '0x1p+40') are not currently accepted. Such arguments could, eg,
    be made "acceptable" if rewritten as '1'.('0'x200) or,
    respectively, '0b1'.('0'x40).
   ...
   OPERATOR OVERLOADING
    ...
    from the exceptions noted below, you will be able to use Math::GMPq and
    Math::MPFR with the overloaded Math::GMPz operations. Such operations
    return Math::MPFR objects calculated in accordance with Math::MPFR
    default precision & default rounding, and (respectively) Math::GMPq
    objects.
